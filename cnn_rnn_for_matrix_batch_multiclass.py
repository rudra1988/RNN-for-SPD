...
data0,label0 = Readdata(file_address='../data_10_2.npz',tot_time_points=tot_time_points,height=height,width=width,true_label=0,class_num=class_num, in_channel=in_channel)
data1,label1 = Readdata(file_address='../data_15_2.npz',tot_time_points=tot_time_points,height=height,width=width,true_label=1,class_num=class_num, in_channel=in_channel)
data2,label2 = Readdata(file_address='../data_20_2.npz',tot_time_points=tot_time_points,height=height,width=width,true_label=2,class_num=class_num, in_channel=in_channel)
data = np.concatenate((data0,data1,data2),axis = 0)
label = np.concatenate((label0,label1,label2),axis = 0)
############################################################################################################################################################################
...
with tf.Session() as sess:
    ...
    for tr_indices, ts_indices in k_fold.split(batch_num_idx):
        ...
        co += 1
    print(final_acc)
    np.save('result_10_15_20_1.npy',final_acc_fold)
